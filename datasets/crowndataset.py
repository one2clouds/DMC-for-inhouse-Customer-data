...
class crown(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for j in os.listdir(os.path.join(self.pc_path, sample['file_path'])):
            # full_path = os.path.join(self.pc_path, sample['file_path'], j)
            # if j.endswith(".npy"):
        ...
        # print(sample['taxonomy_id'])
        # print(sample['model_id'])
        # print(data_gt)
        # print(data_partial)
        # print(value_centroid)
        # print(value_std_pc)
        # print(shell_grid_gt, min_gt, max_gt)
